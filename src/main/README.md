...
Before destroying resources you must delete by hand any backups made by Backup Plan otherwise you will receive error.


## Creating resources

If you are recreating the infrastructure you have to change the name to the secret as the previous deleted one will have the name reserved for 7 days before being permanently deleted.
